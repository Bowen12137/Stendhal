...
public class ElvishArmorTest {
	...
	public void testAttendingtoAttendingOffer() {
		for (final String playerSays : ConversationPhrases.OFFER_MESSAGES) {
			...
			assertThat(playerSays, getReply(npc), is("If you have found any more elvish items, I'd be glad if you would #sell them to me. I would buy elvish armor, hat, shield, legs, boots, cloak or sword. I would also buy a drow sword if you have one."));
			assertThat(playerSays, npcEngine.getCurrentState(), is(ATTENDING));
		}
	}
