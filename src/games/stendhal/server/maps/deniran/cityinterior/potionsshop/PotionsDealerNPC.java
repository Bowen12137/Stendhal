...
public class PotionsDealerNPC implements ZoneConfigurator {
	...
	private void buildNPC(final StendhalRPZone zone) {
		...
		final String shopNameS = "deniranequipsell";
		final String shopNameB = "deniranequipbuy";
		  
		final ShopSign signBuyer = new ShopSign(shopNameB, "Deniran Potions Shop (Buying)", npc.getName() + "You can sell the following items from Deniran Potions.", true);
		signBuyer.setEntityClass("blackboard");
		signBuyer.setPosition(5, 6);

		final ShopSign signSeller = new ShopSign(shopNameS, "Deniran Potions Shop (Selling)", npc.getName() + "You can buy the following items from Deniran Potions.", false);
		signSeller.setEntityClass("blackboard");
		signSeller.setPosition(10, 6);
