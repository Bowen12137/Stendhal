...
public class ElvishArmor extends AbstractQuest implements
	...
	private void offerSteps() {
		...
		npc.add(
				...
				ConversationStates.ATTENDING,
				"If you have found any more elvish items, I'd be glad if you would #sell them to me. I would buy elvish armor, hat, shield, legs, boots, cloak or sword. I would also buy a drow sword if you have one.",
				null);
